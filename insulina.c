...
double decaindo_rapidamente(double x)
{
       if (x >= -3 && x <= -1)
              return (-x - 1) / 2;
       return 0;
...
double aumentando_rapidamente(double x)
{
       if (x > 1 && x <= 3)
              return (x - 1) / 2;
       return 0;
...
int main()
{
       ...
       printf("O taxa de variacao de glicose %lf tem as seguintes pertinencias:\n %lf - decaindo rapidamente \n %lf - decaindo: \n %lf - estavel \n %lf - aumentando \n %lf - aumentando rapidamente\n\n", taxa_glicose, decaindo_rapidamente(taxa_glicose), decaindo(taxa_glicose), estavel(taxa_glicose), aumentando(taxa_glicose), aumentando_rapidamente(taxa_glicose));
       ...
       regras[3][0] = menor_3(alta(glicose), aumentando_rapidamente(taxa_glicose), media(carboidrato));
       printf("%lf - %lf %lf %lf\n", regras[3][0], alta(glicose), aumentando_rapidamente(taxa_glicose), media(carboidrato));
       regras[4][0] = menor_3(10, normal(glicose), media(carboidrato));
       printf("%lf - %d %lf %lf\n", regras[4][0], 10, normal(glicose), media(carboidrato));
       regras[5][0] = menor_3(10, aumentando_rapidamente(taxa_glicose), grande(carboidrato));
       printf("%lf - %d %lf %lf\n", regras[5][0], 10, aumentando_rapidamente(taxa_glicose), grande(carboidrato));
       ...
       regras[9][0] = menor_3(normal(glicose), aumentando_rapidamente(taxa_glicose), pequena(carboidrato));
       printf("%lf - %lf %lf %lf\n", regras[9][0], normal(glicose), aumentando_rapidamente(taxa_glicose), pequena(carboidrato));
